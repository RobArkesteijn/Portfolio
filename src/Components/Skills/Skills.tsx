  ...
  return (
    <>
      ...
      <div className='icon-row7'>
        <i className="devicon-nextjs-original-wordmark icon icon19"></i>
        <i className="devicon-docker-plain icon icon20"></i>
        <i className="devicon-npm-original-wordmark icon icon21"></i>
      </div>
      <div className='icon-row8'>
